...
manual_supplement <- tibble(
  ...
  rep(as.Date("2020-03-30"), 8),
  rep(as.Date("2020-03-31"), 8)),
  county = rep(c("Fairfield", "Hartford", "Litchfield", "Middlesex", "New Haven", "New London", "Tolland", "Windham"), 4),
  cases = c(908, 228, 65, 28, 236, 19, 37, 3,
            1245, 276, 87, 38, 280, 20, 40, 7,
            1445, 330, 113, 59, 373, 24, 50, 10,
            1870, 393, 121, 56, 517, 27, 56, 11),
