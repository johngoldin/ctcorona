...
(based on rolling 14 day average), and the percentage of deaths in that town
...
county_summary <- county_summary %>% 
  ...
  select(county, category, county, total_pop, nh_death_pct, `max cases`, `county cases`,
         `county deaths`, `county cases`, `county deaths`) %>% 
